...
local addonShortName             = 'EST'
local consoleCommand             = "enemyswingtimer"
local consoleCommandShort        = "est"
local consoleCommandOptions      = consoleCommand .. '-options'
local consoleCommandOptionsShort = consoleCommandShort .. '-options'
local globalVarName              = "EST"
...
local function Methods(o)
    ...
    function o:GetMessageLoadedText()
        ...
        return sformat("%s version %s by %s is loaded. %s",
                kch:P(addon) , self:GetAddonInfo(), kch:FormatColor(consoleColors.primary, 'Auraliia'),
