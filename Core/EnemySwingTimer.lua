...
do
    ...
    function o:SlashCommand_Help_Handler()
        ...
        if ns.debug:IsDeveloper() then
            ...
            p:a(function() return C.CONSOLE_OPTIONS_FORMAT, 'dump', 'dump EST' end)
            p:a(function() return C.CONSOLE_OPTIONS_FORMAT, 'dumpns', 'dump EST.ns()' end)
        end
        --@end-do-not-package@
    end
    ...
    function o:SlashCommands(spaceSeparatedArgs)
        ...
        if IsAnyOf('dump', unpack(args)) then
            return ns:K().dump('EST')
        elseif IsAnyOf('dumpns', unpack(args)) then
            return ns:K().dump('EST_NS')
        end
        --@end-do-not-package@
